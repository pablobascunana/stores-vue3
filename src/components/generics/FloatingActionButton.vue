  ...
  <div :class="firstNode">
    <div :class="secondNode">
      <button class="btn-float">
        <svg :id="id" viewBox="0 0 20 20" enable-background="new 0 0 20 20" class="w-6 h-6 inline-block"
        ...
        <svg :id="id" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#FFFFFF"
          v-else
          @click="goToStore"
        >
